...
for kernel_version  in %{?kernel_versions} ; do
	...
	KVER="${kernel_version%%___*}" KSRC="${kernel_version##*___}" \
	module
done
...
%changelog
* Tue Dec 92 2025 Madison Kelly <mkelly@alteeve.ca> - 9.2.16-1.el9
- Updated source to 9.2.16.

* Tue Apr 29 2025 Madison Kelly <mkelly@alteeve.ca> - 9.2.13-1.el9
- Updated source to 9.2.13.

* Mon Dec 02 2024 Madison Kelly <mkelly@alteeve.ca> - 9.2.12-1.el9
- Updated source to 9.2.12.

* Sat Aug 17 2024 Madison Kelly <mkelly@alteeve.ca> - 9.2.11-1.el8
- Updated source to 9.2.11.

* Wed Mar 06 2024 Madison Kelly <mkelly@alteeve.ca> - 9.2.8-1.el8
- Updated source to 9.2.8.

* Sat Jan 13 2024 Madison Kelly <mkelly@alteeve.ca> - 9.2.7-1.el8
- Updated source to 9.2.7.

* Sat Aug 26 2023 Madison Kelly <mkelly@alteeve.ca> - 9.2.5-1.el8
- Updated source to 9.2.5.

* Fri Jun 16 2023 Madison Kelly <mkelly@alteeve.ca> - 9.2.4-1.el8
- Updated source to 9.2.4.

* Wed Apr 05 2023 Madison Kelly <mkelly@alteeve.ca> - 9.2.3-1.el8
- Updated source to 9.2.3.

* Thu Mar 02 2023 Madison Kelly <mkelly@alteeve.ca> - 9.2.2-1.el8
- Updated source to 9.2.2.

* Wed Nov 16 2022 Madison Kelly <mkelly@alteeve.ca> - 9.2.1-1.el8
- Updated source to 9.2.1.

* Tue Nov 15 2022 Madison Kelly <mkelly@alteeve.ca> - 9.1.12-1.el8
- Updated source to 9.1.12.

* Wed Sep 07 2022 Madison Kelly <mkelly@alteeve.ca> - 9.1.11-1.el8
- Updated source to 9.1.11.
